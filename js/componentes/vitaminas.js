...
export function pagina_proteina(){
        ...
        '<div class="contenedor_proteina">'+
            ...
            '<div class="seccion_2">' +
                ...
                '<div class="titulos_proteina">' + 
                    ...
                    '<h2 class="titulo_04">' + 'En Vitaminas' + '</h2>' +
                '</div>' +
            ...
            '<div class="seccion_3">' + 
                ...
                '<img src="https://github.com/NottStevE/Imagenes/blob/main/Proyecto%20aps/Component%20132.png?raw=true" class="recordatorio_movil">' + 
                '<img src="https://github.com/NottStevE/Imagenes/blob/main/Proyecto%20aps/Component%20123.png?raw=true" class="recordatorio_compu">' +
                '<footer>' + 
    ...
    let alimentos_proteinas = ['Huevos', 'Leche', 'Melón', 'Yogurt', 'Hígado', 'Espinaca', 'Zanahoria', 'Guisantes', 'Remolacha', 'Almendras'];
    ...
    function agregar_info_alimentos(){
        alimentos_proteinas.forEach(function(element, index){
            let contenedor = document.createElement("div");
            contenedor.innerHTML = 
                '<h2 class="nombre_fruta_info">' + vitaminas_DATA[index].nombre + '</h2>' +
                '<div class="info_cal">' + 
                    '<p class="kcal">' + vitaminas_DATA[index].kcal + '%Kcal' + '</p>' +
                    '<p class="cal">' + vitaminas_DATA[index].cal + '%cal' + '</p>' +
                '</div>' +
                '<div class="contenido_fruta">' + 
                    '<img class="imagen_fruta_info" src="'+ vitaminas_DATA[index].alimentos_imagenes + '">' +
                    '<img class="imagen_estadistica_info" src="'+ vitaminas_DATA[index].estadistica + '">' +
                    '<img class="porcentaje_info" src="'+ vitaminas_DATA[index].porcentaje + '">' +
                '</div>'
            ;
