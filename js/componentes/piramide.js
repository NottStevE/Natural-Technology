export let insertar_piramide = 
    '<div class="contenedor_piramide">' + 
        '<div class="caja_titulo_piramide">' + 
            '<h2 class="titulo_piramide_1">' + 
                'Pirámide' +
            '</h2>' +
            '<h2 class="titulo_piramide_2">' + 
                'Alimenticia' +
            '</h2>' +
            '<img src="https://github.com/NottStevE/Imagenes/blob/main/Proyecto%20aps/personaje%20piramide%20movil.png?raw=true" class="imagen_movil">' +
