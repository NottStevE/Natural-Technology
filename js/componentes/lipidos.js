...
export function pagina_proteina(){
        ...
        '<div class="contenedor_proteina">'+
            '<div class="seccion_1">' +
                '<div class="contenedor_video">' + 
                    ...
                    '<div class="caja_video">' + 
                        '<iframe width="560" height="315" src="https://www.youtube.com/embed/MPDA7Hd-9h0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>' + '</iframe>' +
                        '<div>' +
            ...
            '<div class="seccion_2">' +
                ...
                '<div class="titulos_proteina">' + 
                    ...
                    '<h2 class="titulo_04">' + 'En Lípidos' + '</h2>' +
                '</div>' +
            ...
            '<div class="seccion_3">' + 
                ...
                '<img src="https://github.com/NottStevE/Imagenes/blob/main/Proyecto%20aps/Component%20131.png?raw=true" class="recordatorio_movil">' + 
                '<img src="https://github.com/NottStevE/Imagenes/blob/main/Proyecto%20aps/Component%20122.png?raw=true" class="recordatorio_compu">' +
                '<footer>' + 
    ...
    function agregar_info_alimentos(){
        alimentos_proteinas.forEach(function(element, index){
            let contenedor = document.createElement("div");
            contenedor.innerHTML = 
                '<h2 class="nombre_fruta_info">' + lipidos_DATA[index].nombre + '</h2>' +
                '<div class="info_cal">' + 
                    '<p class="kcal">' + lipidos_DATA[index].kcal + '%Kcal' + '</p>' +
                    '<p class="cal">' + lipidos_DATA[index].cal + '%cal' + '</p>' +
                '</div>' +
                '<div class="contenido_fruta">' + 
                    '<img class="imagen_fruta_info" src="'+ lipidos_DATA[index].alimentos_imagenes + '">' +
                    '<img class="imagen_estadistica_info" src="'+ lipidos_DATA[index].estadistica + '">' +
                    '<img class="porcentaje_info" src="'+ lipidos_DATA[index].porcentaje + '">' +
                '</div>'
            ;
